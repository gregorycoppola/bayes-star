...
Again, we will be using a ``semantic-role labeling'' syntax instead.
...
\subsection{Propositions Using Semantic Role Syntax}
...
\subsection{Predicates Using Semantic Role Syntax}
